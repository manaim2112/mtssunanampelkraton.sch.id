            ...
            <div className="w-64 mx-auto mt-11">    
                ...
                { alert ? (
                    <div id="alert-border-4" className="flex p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-300 dark:bg-gray-800 dark:border-yellow-800" role="alert">
                        ...
                        Pegawai Register ID (pegId) atau Kata sandi anda salah <Link to="#" className="font-semibold underline hover:no-underline">Lupa sandi ?</Link>. Silahkan hubungi operator sekolah.
                        </div>
                ...
                <div className="mb-6 mt-8">
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pegawai Register ID (pegId)</label>
