...
export function JumbrotonElement({badge, title, desc, to}) {
    return(
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:px-8 mb-8">
                ...
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">{desc}</p>
                <Link to={to} className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Read more
